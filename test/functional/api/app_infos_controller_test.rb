...
class Api::AppInfosControllerTest < ActionController::TestCase
  def test_index
    get :index
  ...
  def test_create_valid
    ...
    post :create
    assert_redirected_to api_app_info_url(assigns(:app_info))
  end
  ...
  def test_destroy
    ...
    assert_redirected_to api_app_infos_url
